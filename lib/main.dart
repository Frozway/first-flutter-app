...
import 'package:first_flutter_app/pages/player/player_form_page.dart';
import 'package:first_flutter_app/pages/player/player_list_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'First Flutter App - Thibaut LEFRANCOIS',
      theme: ThemeData(
      ...
      routes: {
        ...
        '/player': (context) => const PlayerFormPage(),
      },
